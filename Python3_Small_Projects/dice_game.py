...
def diceroll():
    # save our user input
    try:
        dice_sides = input("Please enter the number of sides of the dice: ")
        roll_times = input("Please enter the number of times you want to roll: ")
    ...
    user_stat = input("Do you want to see stats, Y/N: ")
    assert isinstance(user_stat, str), "input must be a string 'Y or N'"
    user_stat = user_stat.upper()
    if user_stat == "Y":
        user_num = input("Enter the number you would like to see stats for: ")
