# t 140m
# importing to Python 3 and adding user input has introduced many bugs

#from math import floor
#import decimal

print ("Welcome to averages calculator")
...
def mean(number_list):
    ...
    decimal_place = input("Select how many decimal points you want to round the answer to: ")
...
def user_choice():
    """
    Prompts the user to choose one of the averaging functions above
    and to enter a list of numbers.
    Then runs the function with the numbers provided
    """

    # this function isn't yet finished
    # the user input requires more data type formatting to work

    print("You may calculate: \nmean \nmedian \nmode \nrange")
    user_input = input("Please pick a function from above: ")
    #user_input = user_input.lower

    print("user_input:", user_input)

    number_list = input("Please enter a list of numbers you would like to calculate:")
    ...
    if user_input == "mode":
        mode(number_list)
    if user_input == "median":
        median(number_list)
    if user_input == "range":
        _range(number_list)
    else:
        print ("Invalid selection, please check your spelling")
        user_choice()
