...
# user word input
familymember = input("Please enter a family member role, e.g, uncle: ")
adjective = input("Please enter an adjective to describe them, e.g, wild: ")
verb1 = input("Please enter an activity they would do: ")
verb2 = input("Please enter another similar activity they would do: ")
word = input("Please enter a fictional name for a trophy: ")
